...
<div class="row">
    <div class="col-lg-12">
        ...
        <sec:authorize access="hasAuthority('ADMIN'))">ddd</sec:authorize>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
<button type="button" class="btn btn-info" onclick="location.href='/customLogin'">로그인</button>
<button type="button" class="btn btn-info" onclick="location.href='/customLogout'">로그아웃</button>
<div class="row">
    <div class="col-lg-12">

 ...
 * Generated at: 2023-12-08 06:55:03 UTC
...
public final class get_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/board/../includes/footer.jsp", Long.valueOf(1699509334000L));
    _jspx_dependants.put("jar:file:/D:/javaWork/spring/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/ex07/WEB-INF/lib/spring-security-taglibs-5.0.7.RELEASE.jar!/META-INF/security.tld", Long.valueOf(1532606274000L));
    _jspx_dependants.put("/WEB-INF/lib/spring-security-taglibs-5.0.7.RELEASE.jar", Long.valueOf(1700445080081L));
    _jspx_dependants.put("jar:file:/D:/javaWork/spring/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/ex07/WEB-INF/lib/jstl-1.2.jar!/META-INF/c.tld", Long.valueOf(1153352682000L));
    _jspx_dependants.put("/WEB-INF/views/board/../includes/header.jsp", Long.valueOf(1700125070000L));
    _jspx_dependants.put("/WEB-INF/lib/jstl-1.2.jar", Long.valueOf(1691733144298L));
    _jspx_dependants.put("jar:file:/D:/javaWork/spring/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/ex07/WEB-INF/lib/jstl-1.2.jar!/META-INF/fmt.tld", Long.valueOf(1153352682000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <div class=\"panel panel-default\">\r\n");
      out.write("            <div class=\"panel-heading\">\r\n");
      out.write("            	<i class=\"fa fa-comments fa-fw\"></i>Reply		<!-- w3school-부트스트랩4-아이콘 참고 -->\r\n");
      out.write("            	");
      ...
      out.write("               		<li class=\"left clearfix\" data-rno='12'>	<!-- getList에서 고쳐 쓸 부분. user00의 댓글은 표시되지 않음 -->\r\n");
      out.write("               			<div>\r\n");
      ...
      out.write("					<input class=\"form-control\" name=\"replyer\" id=\"replyer\" value=\"Replyer\"/>\r\n");
      out.write("				</div>\r\n");
      out.write("				<div class=\"form-group\">\r\n");
      ...
      out.write("				<button id=\"modalCloseBtn\" type=\"button\" class=\"btn btn-info\" data-dismiss=\"modal\">Close</button>\r\n");
      out.write("			</div>\r\n");
      out.write("\r\n");
      out.write("		</div>\r\n");
      out.write("	</div>\r\n");
      ...
      out.write("								pageNum = Math.ceil(replyCnt/10.0);		//댓글 갯수가 10개를 넘어가면 다음 페이지로 이동함\r\n");
      ...
      out.write("								str += \"<li class='left clearfix' data-rno='\" + list[i].rno + \"'>\"; //안쪽에 작은 따옴표로 바꾸기. rno값 주의.\r\n");
      out.write("								str += \"<div><div class='header'>\";\r\n");
      out.write("								str += \"<strong class='primary-font'>\"\r\n");
      out.write("										+ list[i].replyer + \"</strong>\";\r\n");
      out.write("								str += \"<small class='pull-right text-muted'>\"\r\n");
      out.write("										+ replyService\r\n");
      out.write("												.displayTime(list[i].replyDate)\r\n");
      out.write("										+ \"</small>\";\r\n");
      out.write("								//str += \"</div><p>\" + list[i].reply + \"</p>\";\r\n");
      out.write("								str += \"</div><p>\" + list[i].reply + \"</p>\";\r\n");
      ...
      out.write("		modalInputReplyDate.closest(\"div\").hide();	//날짜를 숨기겠다\r\n");
      out.write("		modal.find(\"button[id != 'modalCloseBtn']\").hide();	//close버튼을 제외한 모든 버튼을 숨김\r\n");
      out.write("		\r\n");
      out.write("//		//readonly 속성 제거\r\n");
      out.write("//		modalInputReplyer.removeAttr(\"readonly\");\r\n");
      out.write("		modalInputReplyer.attr(\"readonly\", \"readonly\") ;\r\n");
      out.write("		\r\n");
      out.write("		modalRegisterBtn.show();					//register 버튼을 보여줌\r\n");
      out.write("		\r\n");
      out.write("		$(\".modal\").modal(\"show\");		//class로 접근\r\n");
      out.write("	});\r\n");
      out.write("	\r\n");
      ...
      out.write("			modalInputReplyer.val(reply.replyer).attr(\"readonly\", \"readonly\") ;\r\n");
      out.write("			modalInputReplyDate.val(replyService.displayTime(reply.replyDate)).attr(\"readonly\", \"readonly\"); //읽기전용 변경\r\n");
      ...
      out.write("		var rno = modal.data(\"rno\");				//showList()를 통해 data-rno를 추가해 주었음.\r\n");
      out.write("		\r\n");
      out.write("		if(!replyer){\r\n");
      ...
      out.write("		var originalReplyer = modalInputReplyer.val();\r\n");
      out.write("		\r\n");
      out.write("		console.log(\"Original Replyer: \" + originalReplyer); //댓글 원작성자\r\n");
      out.write("		\r\n");
      out.write("		if(replyer != originalReplyer){\r\n");
      ...
      out.write("	\r\n");
      out.write("	//add\r\n");
      out.write("	/* var addValue = {\r\n");
      out.write("			reply : \"JS TEST\",\r\n");
      out.write("			replyer : \"TESTER\", \r\n");
      out.write("			bno : bnoValue				//자바객체\r\n");
      out.write("	}\r\n");
      out.write("								//callback에 대응되는 함수\r\n");
      out.write("	replyService.add(addValue, function(result) {	//json 타입으로 변환.\r\n");
      out.write("		alert(\"RESULT : \" + result)\r\n");
      out.write("	});	//js의 replyService-add 호출 */\r\n");
      out.write("\r\n");
      out.write("	//getList\r\n");
      out.write("	/* replyService.getList({bno:bnoValue, page:1}, function(list){\r\n");
      out.write("		for(var i=0, len=list.length || 0; i<len; i++){		//list.length에 값이 없다면 0, \r\n");
      out.write("			console.log(list[i]);\r\n");
      out.write("		}\r\n");
      out.write("	}); */\r\n");
      out.write("\r\n");
      out.write("	//delete\r\n");
      out.write("	/* replyService.remove(49, \r\n");
      ...
      out.write("			{rno:17, reply:\"Modify Reply...\"},\r\n");
      out.write("			function(data) {\r\n");
      out.write("				alert(\"수정완료 : \" + data);\r\n");
      out.write("			},\r\n");
      out.write("			function(er) {\r\n");
      out.write("				alert(\"실패 : \" + er);\r\n");
      out.write("			}\r\n");
      out.write("	); */\r\n");
      out.write("\r\n");
      out.write("	//read, get\r\n");
      ...
      out.write("			41,						\r\n");
      out.write("			function(data) {			\r\n");
      out.write("				console.log(data);			//없으면 null값 반환\r\n");
      out.write("			},\r\n");
      out.write("			function(err) {\r\n");
      ...
      out.write("						str += \"		<img src='/resources/img/test-image.jpg'></a>\";\r\n");
      out.write("						str += \"	</div>\";\r\n");
      out.write("						str += \"</li>\";\r\n");
      out.write("					}\r\n");
      out.write("					\r\n");
  ...
  private boolean _jspx_meth_c_005fout_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/get.jsp(27,63) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_sec_005fauthentication_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/get.jsp(42,16) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_sec_005fauthentication_005f0.setProperty("principal");
      // /WEB-INF/views/board/get.jsp(42,16) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_sec_005fauthorize_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/get.jsp(43,16) name = access type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/get.jsp(44,17) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_sec_005fauthorize_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/get.jsp(97,13) name = access type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_sec_005fauthorize_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/get.jsp(277,1) name = access type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_sec_005fauthentication_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_sec_005fauthorize_005f2, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/get.jsp(278,13) name = property type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/get.jsp(526,14) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
